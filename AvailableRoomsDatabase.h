...
//   vector< AvailableRooms >::iterator begin();
//   vector< AvailableRooms >::iterator end();
//   void returnAvailableRooms( unsigned int, unsigned int, vector< AvailableRooms >::iterator, vector< AvailableRooms >::iterator );
//   unsigned int size();
private:
